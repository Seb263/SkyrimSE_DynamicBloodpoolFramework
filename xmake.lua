...
-- project infos
local projectName = "DynamicBloodpoolFramework"
...
target(projectName)
	...
	add_rules("commonlibsse-ng.plugin", {
		name = projectName,
		author = "Seb263",
		description = "Dynamic Bloodpool Framework binaries"
	})
    ...
    add_files("extern/Papyrus/DynamicBloodpoolFramework.psc")
    add_files("extern/Papyrus/DynamicBloodpoolFramework.pex")
